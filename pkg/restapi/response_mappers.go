...
import (
	...
	gs "github.com/ncotds/nco-qoordinator/pkg/restapi/gen"
)
...
func queryResultToResponse(name string, qr qc.QueryResult) (gs.RawSQLResponse, error) {
...
func queryRowToResponseRow(in qc.QueryResultRow) (map[string]jx.Raw, error) {
