...
import (
	...
	dbconnector "github.com/ncotds/nco-qoordinator/internal/dbconnector"
...
func (_m *MockDBConnector) Connect(ctx context.Context, addr dbconnector.Addr, credentials models.Credentials) (dbconnector.ExecutorCloser, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, dbconnector.Addr, models.Credentials) (dbconnector.ExecutorCloser, error)); ok {
		return rf(ctx, addr, credentials)
	}
	if rf, ok := ret.Get(0).(func(context.Context, dbconnector.Addr, models.Credentials) dbconnector.ExecutorCloser); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, dbconnector.Addr, models.Credentials) error); ok {
...
func (_c *MockDBConnector_Connect_Call) Run(run func(ctx context.Context, addr dbconnector.Addr, credentials models.Credentials)) *MockDBConnector_Connect_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(dbconnector.Addr), args[2].(models.Credentials))
	})
	return _c
}
